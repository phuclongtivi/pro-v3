...
export default function EventSpace(){
 ...
 return <main className="page eventSpace">
  ...
  <div className="serviceDock">{services.map(x=><button data-action-id="pro.app.event.token.page.button.002" key={x} className={service===x?"active":""} onClick={()=>setService(x)}>{x}</button>)}</div>
