...
import {playWelcome,playStartup} from "@/core/audio-engine";
...
export function LanguageProvider({children}:{children:React.ReactNode}){
 ...
 function firstChoose(v:Lang){setLangState(v);localStorage.setItem("long-language",v);document.documentElement.lang=v;localStorage.setItem("long-welcome-seen","1");setShowGate(false);setWelcome(true);playWelcome().catch(()=>{})}
