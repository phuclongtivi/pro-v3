...
for(const x of ['qr-create','external-app','display-output','ai-bill','ai-ticket','ai-sales','device','audio-control','media-render','inventory','orders']) if(!sem.includes(`"${x}"`)) failures.push(`missing semantic intent ${x}`);
